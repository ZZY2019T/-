...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                城市重开模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">这垃圾城市一秒也不想留了</div>
            </div>
                    ...
                    .forEach(talent=>{
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                if(this.#talentSelected.size==3) {
                                    talentPage.find('#next').text('开始新城市人生')
                                }
                            }
                        });
                    });
        ...
        groups.THY = getBtnGroups("颜值", 0, 10); // 理论 theory THY
        groups.TKG = getBtnGroups("技术", 0, 10); // 技术 technology TKG
        groups.LBF = getBtnGroups("人才", 0, 10); // 人才 labor force LBF
        groups.PLC = getBtnGroups("政策", 0, 10); // 政策 policy PLC
        ...
        propertyPage
            ...
            .click(()=>{
                ...
                groups.THY.set(10 - arr[0]);
                groups.TKG.set(10 - arr[1]);
                groups.LBF.set(10 - arr[2]);
                groups.PLC.set(10 - arr[3]);
            });
        ...
        <div id="main">
            ...
            <div class="btn-area">
                ...
                <button id="summary" class="mainbtn">历史总结</button>
                <button id="domToImage" class="mainbtn">历史回放</button>
            </div>
        ...
        trajectoryPage
            ...
            .click(()=>{
                ...
                $("#lifeProperty").html(`
                <li><span>理论</span><span>${property.THY}</span></li>
                <li><span>技术</span><span>${property.TKG}</span></li>
                <li><span>人才</span><span>${property.LBF}</span></li>
                <li><span>政策</span><span>${property.PLC}</span></li>
                <li><span>资本</span><span>${property.PRT}</span></li>
                `);
            });
        // html2canvas
        trajectoryPage
        ...
        <div id="main">
            ...
            <ul id="judge" class="judge">
                <li class="grade2"><span>理论：</span><span>9级 理论大爆炸</span></li>
                <li class="grade0"><span>技术：</span><span>4级 技术一般</span></li>
                <li class="grade0"><span>人才：</span><span>1级 急缺人才</span></li>
                <li class="grade0"><span>政策：</span><span>6级 政策鼓励</span></li>
                <li class="grade0"><span>历史：</span><span>3年 早夭</span></li>
                <li class="grade0"><span>资本：</span><span></span>3级 不太富裕的发展</li>
            </ul>
